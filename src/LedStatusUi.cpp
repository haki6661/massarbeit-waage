...
void LedStatusUi::startRaceLights(uint16_t holdMs, uint16_t lampIntervalMs, uint8_t lampCount) {
    if (ledRing_) ledRing_->startRaceLights(holdMs, lampIntervalMs, lampCount);
}
